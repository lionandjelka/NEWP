...
def periods (lcID, data, ngrid, plot = False, save = False, peakHeight = 0.6, prominence = 0.7, minfq = 1500, maxfq = 10, xlim = None): 
...
def signif_johnoson(numlc, peak, idx_peaks, yax, tt, yy, ntau,ngrid, f = 2, peakHeight = 0.6, minfq = 1500, maxfq = 10, algorithm ='wwz', method = 'linear'):
